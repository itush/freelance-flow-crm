      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          >
            ...
            <span className="absolute -inset-0.5 animate-spin-slow rounded-full bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 opacity-0 transition-opacity duration-500 group-hover:opacity-75"></span>
